 ...
 * @author shruti
 */
public class doctordelname extends javax.swing.JFrame {

    /**
     * Creates new form doctordelname
     */
    public doctordelname() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctordelname.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctordelname().setVisible(true);
            }
        });
    }
