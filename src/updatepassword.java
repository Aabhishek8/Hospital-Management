...
public class updatepassword extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(confirm, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(21, 21, 21)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
          int num=0;
        String olds=old.getText();
        String newps=newp.getText();
        String confirms=confirm.getText();
        if(newps.equals(confirms))
        {
            ...
            try
        {
                    ...
                    if(num>=1)
                    {
                         String query1="update admin set password=? where password=?";
                         PreparedStatement pst1=con.prepareStatement(query1);
                    pst1.setString(1, newps);
                    pst1.setString(2,olds);
                    ...
                    {
                        JOptionPane.showMessageDialog(null,"record doesn't "
                                + "exist");
                    }
                    }
        catch(Exception ae)
        ...
        {
         JOptionPane.showMessageDialog(null,"please reenter the password");   
        }
